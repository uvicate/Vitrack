...
void Touch_Tests(void)
{
  ...
  //BOTONES
        ...
        Display.gfx_Button(ON , 30,20, YELLOW, RED, FONT3, 3.5, 4, "Boton1") ;
     //   Display.gfx_ClipWindow(30,20, 180, 75);
 
        Display.gfx_Button(ON, 30,90, YELLOW, RED, FONT3, 3.5, 4, "Boton2") ;
       // Display.gfx_ClipWindow(30,90, 180, 145) ;
     
        Display.gfx_Button(ON, 30,160, YELLOW, RED, FONT3, 3.5, 4, "Boton3") ;
    //    Display.gfx_ClipWindow(30,160, 180, 215) ;
 
        Display.gfx_Button(ON, 30,230, YELLOW, RED, FONT3, 3.5, 4, "Boton4") ;
  ...
  ,,,,SI QUIERES SELECCIONAR 2 O MAS BOTONES HACERLO CON ELSE IF*///////////////////
    do
      {    
        ...
        Display.gfx_Button(OFF , 30,20, YELLOW, RED, FONT3, 3.5, 4, "Boton1") ;
        ...
        Display.gfx_Button(OFF, 30,90, YELLOW, RED, FONT3, 3.5, 4, "Boton2") ;
       ...
       else if((x >= 30 && x <= 180) && (y >= 160 && y <= 215))  //TERCER BOTON
            {
             ...
             Display.gfx_Button(OFF, 30,160, YELLOW, RED, FONT3, 3.5, 4, "Boton3") ;
        ...
        else  if((x >= 30 && x <= 180) && (y >= 230 && y <= 285))  // CUARTO BOTON
           {
                ...
                Display.gfx_Button(OFF, 30,230, YELLOW, RED, FONT3, 3.5, 4, "Boton4") ;
                // make it really dark  
       }
